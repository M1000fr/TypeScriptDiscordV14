import { ApplicationCommandData, ChatInputCommandInteraction, Colors, PermissionResolvable } from "discord.js";
...
export default class Commands {
    ...
    constructor(options: ApplicationCommandData, requiredPermissions?: PermissionResolvable[]) {
